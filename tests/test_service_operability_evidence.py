...
EVIDENCE_PATH = ROOT / "docs" / "benchmarks" / "service_operability_2026-08-09.json"
PLOT_PATH = ROOT / "docs" / "assets" / "service_operability_2026-08-09.png"
...
def test_make_target_stages_candidates_without_targeting_committed_references() -> None:
    ...
    assert "docs/benchmarks/service_operability_2026-08-09.json" in section
    assert "docs/assets/service_operability_2026-08-09.png" in section
